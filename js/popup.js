...
window.setInterval(function(){
    ...
    if (i==0){chat.innerHTML +="<p style='color:blue'>Local Girl: Hey are you in <i>Antwerp Area</i>?</p>";}
    else if (i==1){chat.innerHTML +="<p style='color:blue'>Local Girl: moew meow meow meow!!</p>";}
